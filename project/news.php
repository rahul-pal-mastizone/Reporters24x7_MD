...
$totalRes = $conn->query("SELECT COUNT(*) as cnt FROM posts WHERE type='news'");
$total = $totalRes->fetch_assoc()['cnt'];
$totalPages = ceil($total/$limit);

$posts = $conn->query("SELECT * FROM posts WHERE type='news' ORDER BY created_at DESC LIMIT $limit OFFSET $offset");
?>
<!DOCTYPE html>
<html lang="hi">
<head>
...
<div class="container mt-4">
    <div class="card bg-secondary p-4">
        <h2><i class="fa fa-newspaper text-info"></i> नवीनतम समाचार</h2>
